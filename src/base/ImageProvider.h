...
public:
  ...
  wxBitmap getFileBasedBitmap(const wxString &s, const int rotateHue = 0,
                              const bool storeInCache = true);
  wxBitmap *getFileBasedBitmapRef(const wxString &s, const int rotateHue = 0,
                                  const bool storeInCache = true);
  wxBitmap getFileBasedBitmapConservative(const wxString &s,
                                          const int rotateHue);
...
private:
  ...
  wxString bitmapId2Name(const BitmapId &);
  ImageProvider();
};
