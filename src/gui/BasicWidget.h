...
extern const wxEventType COMMAND_CHART_SKIN_CHANGED;
...
#define WO_EXPORT_ALL                                                          \
  WO_EXPORT_GRAPHIC | WO_EXPORT_PDF | WO_EXPORT_PLAINTEXT |                    \
      WO_EXPORT_HTMLTEXT | WO_EXPORT_CSVTEXT

/*************************************************/ /**
                                                     *
                                                     * \brief Basic abstract
                                                     * class for graphical
                                                     * display based upon
                                                     * wxScrolledWindow
                                                     *
